  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-background p-md relative overflow-hidden">
      ...
      <div className="w-full max-w-[480px] bg-white/95 backdrop-blur-md rounded-[16px] shadow-[0_4px_20px_rgba(99,102,241,0.08)] p-lg relative z-10 hover:shadow-[0_8px_30px_rgba(99,102,241,0.12)] transition-shadow duration-300">
        ...
        <div className="mb-md">
          <h2 className="font-headline-md text-headline-md text-on-surface mb-1">Create an account</h2>
          <p className="font-body-md text-body-md text-on-surface-variant">Please enter your details to register.</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-[24px]">
        ...
        <p className="mt-8 text-center font-body-md text-body-md text-on-surface-variant">
          Already have an account? <Link href="/login" className="font-label-md text-label-md text-primary hover:text-primary-container transition-colors">Login here</Link>
        </p>
      </div>
    </main>
  );
